    ...
    <main className="min-h-screen bg-white">
      ...
      <StatsSection
        ...
        stats={[
          ...
          {
            value: 5000, suffix: "+", label: "Play Store Downloads",
          ...
          },
          {
            ...
            icon: <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M9 12l2 2 4-4"/></svg>,
          },
          {
