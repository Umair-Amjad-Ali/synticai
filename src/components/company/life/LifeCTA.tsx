...
export default function LifeCTA() {
  return (
    <section className="w-full relative z-20 py-20 bg-[#0A051E] overflow-hidden border-t border-t-white/5">
      
      {/* Background Decor */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-5xl h-[200px] bg-[#1C75BC]/10 blur-[80px] pointer-events-none" />
        ...
        >
          ...
          <div className="text-center md:text-left flex-1 max-w-lg">
            <div className="inline-flex items-center gap-2 mb-4">
              <div className="w-1.5 h-1.5 rounded-full bg-[#1C75BC] animate-pulse" />
              <span className="text-[#1C75BC] text-[11px] font-bold tracking-[0.2em] uppercase">Careers at SynticAI</span>
            </div>
          ...
          <div className="shrink-0">
            ...
            >
              {/* Button Shadow */}
              <div className="absolute inset-0 bg-linear-to-r from-[#1C75BC] to-[#101254] rounded-2xl blur-md opacity-40 group-hover/btn:opacity-80 transition-opacity duration-300" />
              
              <div className="relative flex items-center justify-between gap-6 px-8 py-5 bg-[#0A051E] border border-white/10 group-hover/btn:border-[#45d1f5]/50 transition-colors duration-300 text-white font-bold text-base rounded-2xl overflow-hidden shadow-2xl">
                 <span className="relative z-10 group-hover/btn:text-[#1C75BC] transition-colors">View Open Roles</span>
                 
                 <div className="w-10 h-10 rounded-xl bg-linear-to-br from-[#1C75BC] to-[#101254] flex items-center justify-center relative z-10 group-hover/btn:scale-110 transition-transform duration-300 shadow-inner">
