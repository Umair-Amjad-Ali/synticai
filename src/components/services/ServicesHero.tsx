...
export default function ServicesHero() {
  ...
  return (
    <section className="relative w-full min-h-[calc(100vh-80px)] flex items-center overflow-hidden bg-dark-bg pt-20 ">
      {/* Advanced Background Gradients */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-20%] right-[-10%] w-[800px] h-[800px] bg-linear-to-b from-brand/20 to-transparent rounded-full blur-[150px]" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-linear-to-tr from-brand-light/10 to-transparent rounded-full blur-[120px]" />
      ...
      <div className="max-w-6xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-20 lg:gap-8 relative z-10">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center text-left">
          ...
          >
            Empowering the <br/>
            <span className="text-transparent bg-clip-text brand-gradient-text drop-shadow-[0_0_30px_rgba(69,209,245,0.3)]">
              Digital Era.
            </span>
          </motion.h1>
          ...
          >
            <Link 
              href="#ai-ml"
              className="group flex items-center gap-2 px-6 py-3 bg-white text-dark-bg font-bold rounded-full hover:bg-brand hover:text-white transition-all duration-300 transform hover:scale-105 shadow-[0_10px_30px_rgba(255,255,255,0.1)]"
            >
      ...
      <div className="absolute bottom-0 inset-x-0 h-32 bg-linear-to-t from-dark-bg to-transparent pointer-events-none z-10" />
    </section>
  );
}
